    ...
    return (
        <div className="text-[#ede7d9] text-center flex flex-col gap-4 text-sm mt-12">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                <img className="w-35 lg:w-45" src="./src/assets/Icono-1.webp"></img>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                <img className="w-35 lg:w-45" src="./src/assets/Icono-2.webp"></img>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                <img className="w-35 lg:w-45" src="./src/assets/Icono-3.webp"></img>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                <img className="w-35 lg:w-45" src="./src/assets/Icono-4.webp"></img>
