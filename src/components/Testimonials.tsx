    ...
    return (
        <div className="flex flex-col text-[#ede7d9] mt-12 gap-4 text-xs px-8 text-center">
            ...
            <div className="flex flex-col items-center text-center gap-4">
                <img className="rounded-full h-30 w-30 object-cover" src="./src/assets/Testimonial-1.webp"></img>
            ...
            <div className="flex flex-col items-center text-center gap-4">
                <img className="rounded-full h-30 w-30 object-cover" src="./src/assets/Testimonial-2.webp"></img>
            ...
            <div className="flex flex-col items-center text-center gap-4">
                <img className="rounded-full h-30 w-30 object-cover" src="./src/assets/Testimonial-3.webp"></img>
